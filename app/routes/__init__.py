...
from app.handlers import eliminar_ingreso, get_ingreso_por_id, validar_usuario, get_ingreso, agregar_ingreso
...
def index():
    ...
    return render_template('index.html', titulo="Inicio", ingreso=get_ingreso())
...
def ingresar_ingreso():
    ...
    if ingreso_form.validate_on_submit():
        datos_nuevos = { 'fecha': ingreso_form.fecha.data,
                         'nombre': ingreso_form.nombre.data, 
